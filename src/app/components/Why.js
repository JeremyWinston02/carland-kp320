    ...
    <section className='section flex items-center' id='why'>
      <div className="container mx-auto">
        ...
        className="max-w-[680px] text-center mx-auto mb-2">
          Our dedication to providing exceptional services sets us apart from the competition. From the moment you engage with us, we strive to exceed expectations in every interaction.
        </motion.p>
        ...
        className="flex flex-wrap justify-center xl:grid xl:grid-cols-3 gap-4 xl:gap-y-0 xl:gap-x-[30px]">
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
            ...
            <p className="hidden xl:flex">
              We prioritize your need and we go above and beyond to ensure your experience us is nothing short of outstanding.
            </p>
