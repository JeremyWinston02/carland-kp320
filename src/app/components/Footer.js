      ...
      <div className="container mx-auto mb-24">
        ...
        className="flex flex-col lg:flex-row lg:justify-between gap-x-5 gap-y-14">
          ...
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            {/* text */}
            <div className="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscising elit.</div>
          ...
          <div className="flex-1 ">
            ...
            <div className="flex flex-col hap-y-4">
          ...
          <div className="flex-1 ">
            ...
            <div className="mb-9 text-secondary">Lorem ipsum sit amet consectetur adipiscing elit.</div>
            {/* form */}
